...
--
-- Current Database: `atividades`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `atividades` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `atividades`;

--
-- Table structure for table `ciclismo`
--

DROP TABLE IF EXISTS `ciclismo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ciclismo` (
  `idCiclismo` int NOT NULL AUTO_INCREMENT,
  `nomeCiclismo` varchar(100) DEFAULT NULL,
  `paisCiclismo` varchar(100) DEFAULT NULL,
...
CREATE TABLE `skate` (
  ...
  `nomeSkate` varchar(100) DEFAULT NULL,
  `paisSkate` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`idSkate`)
...
DROP TABLE IF EXISTS `tudo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tudo` (
  `idTudo` int NOT NULL AUTO_INCREMENT,
  `nomeTudo` varchar(100) DEFAULT NULL,
  `paisTudo` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`idTudo`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Current Database: `aula_2811`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `aula_2811` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
--
-- Current Database: `curso_data_science`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `curso_data_science` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `curso_data_science`;
...
--
-- Table structure for table `vendas_games`
--

DROP TABLE IF EXISTS `vendas_games`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vendas_games` (
  `id_venda` int NOT NULL AUTO_INCREMENT,
  `nome_jogo` varchar(100) NOT NULL,
  `plataforma` varchar(50) DEFAULT NULL,
  `preco` decimal(10,2) DEFAULT NULL,
  `data_venda` date DEFAULT NULL,
  `loja_cidade` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id_venda`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Current Database: `registros`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `registros` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `produtos` (
  ...
  KEY `my_fk` (`tipoproduto`),
  CONSTRAINT `produtos_ibfk_1` FOREIGN KEY (`tipoproduto`) REFERENCES `tipoprodutos` (`codtpprodutos`),
  CONSTRAINT `produtos_ibfk_2` FOREIGN KEY (`tipoproduto`) REFERENCES `tipoprodutos` (`codtpprodutos`)
...
CREATE TABLE `tipoprodutos` (
  `codtpprodutos` int NOT NULL,
  `nomedescricao` varchar(50) NOT NULL,
  PRIMARY KEY (`codtpprodutos`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Current Database: `universidade_u`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `universidade_u` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
-- Dump completed on 2025-12-05 16:43:45
